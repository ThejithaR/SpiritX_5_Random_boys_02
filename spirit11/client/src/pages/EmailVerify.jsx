  ...
  const onSubmitHandler = async(e)=>{
    try{
      ...
      if (data.success){
        ...
        getUserData(); //getting userData again becouse now the user is verified so new data should be fetched
        navigate("/")
      }else{
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600">
      <img
        ...
        src={assets.logo}
        alt=""
        className="absolute left-5 sm:left-20 top-5 w-14 sm:w-15 cursor-pointer"
      />
      <form
